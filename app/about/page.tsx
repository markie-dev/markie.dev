            ...
            <div className="relative z-10 h-full">
              {isLoading ? (
                <div className="p-4 flex items-center gap-4 rounded-xl bg-gray-200/80 dark:bg-gray-800/80 backdrop-blur-sm h-full">
                  ...
                  {/* Text content skeleton */}
                  <div className="flex flex-col gap-2 flex-grow">
                    <Skeleton className="h-4 w-20" /> {/* "Now Playing" text */}
                    <Skeleton className="h-6 w-3/4" /> {/* Song title */}
                    <Skeleton className="h-4 w-1/2" /> {/* Artist name */}
                  </div>

                  {/* Music note icon skeleton */}
